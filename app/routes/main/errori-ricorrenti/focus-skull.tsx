...
export const Route = createFileRoute('/main/errori-ricorrenti/focus-skull')({
  component: FocusSkullPage,
});
...
function FocusSkullPage(): JSX.Element {
  ...
  const domandeQuery = useInfiniteQuery({
    queryKey: ['errori-ricorrenti', 'focus-skull', period],
    ...
    <div className="space-y-4">
      ...
      <div className="sticky top-[calc(var(--header-height,3.5rem)+4.5rem)] sm:top-[calc(var(--header-height,3.5rem)+3rem)] z-10 border-b border-border bg-background py-2 shadow-[0_-1rem_0_0_var(--color-background)]">
        <div className="flex items-baseline gap-2">
          ...
          <h1 className="text-xl font-bold">Focus Skull</h1>
        </div>
      </div>

      <p className="text-sm text-muted-foreground">
        Domande che hai marcato come difficili
      </p>
